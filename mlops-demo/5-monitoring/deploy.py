...
def deploy_to_cloud_run(project_id):
    ...
    service_name = "sentiment-analysis-api-monitored"
    region = "us-central1"
    
    print("\n🚀 Deploying monitored service to Cloud Run...")
...
def test_deployment(service_url):
    ...
    try:
        test_data = {"text": "This is a test of the monitored deployment!"}
...
def main():
    print("🚀 Starting deployment of monitored service...")
    ...
    if test_deployment(service_url):
        ...
        print(f"\nYour monitored API is now available at: {service_url}")
        print(f"You can access the API documentation at: {service_url}/docs")
        print(f"\nMetrics will be available in the Cloud Monitoring console.")
        print(f"View your dashboard at: https://console.cloud.google.com/monitoring/dashboards")
    else:
